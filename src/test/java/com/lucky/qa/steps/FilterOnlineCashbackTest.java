...
public class FilterOnlineCashbackTest {
    ...
    public void verifyFilterWithWithBackendAccordingTo(String category, String languageValue) throws InterruptedException {
        APIresult = implementMethodsObject.getAffiliateMerchantsByCategory(category, languageValue);
