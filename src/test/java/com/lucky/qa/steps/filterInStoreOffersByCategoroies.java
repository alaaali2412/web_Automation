...
public class filterInStoreOffersByCategoroies {
    ...
    public void browser_open_portal_open_in_store_offer_screen() throws InterruptedException {
    ...
    public void user_choose_specfic_from_right_menu_choose_if_required(String mainCategory, String mainSubCategory, String subCategory) throws InterruptedException {
        PageGenerator.getInstance(InStoreOfferPage.class, driver).filterByCategory(mainCategory, mainSubCategory,subCategory );
