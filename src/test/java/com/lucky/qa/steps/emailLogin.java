...
public class emailLogin {
   ...
   public String loggedEmail;
    ...
    public void browser_open_navigate_to_portal() throws Exception {

    }

    @When("close the pop up click on login button")
    public void close_the_pop_up_click_on_login_button() throws Exception {
    ...
    public void verify_the_login() throws Exception {
       //PageGenerator.getInstance(HomePage.class,driver).closePopUp();
      Assert.assertEquals(loggedEmail,  PageGenerator.getInstance(HomePage.class, driver).checkUserLogin());
